  ...
  const testimonials = [
    {
      ...
      image: "/Testimonials/Vijaya Tapaswi Achanta.jpg",
       outcomes: [
        {
          label: "Published a research paper under Dr.Madhan’s mentorship.",
          type: "image",
          value: "/HOME/madhannew.jpg",
        },
        {
          label: "Completed a cloud security taxonomy study.",
          type: "link",
          value: "/research/cloud-taxonomy",
        },
        {
          label: "Initiated a patent filing process based on the paper.",
          type: "image",
          value: "/Papers/patent.jpg",
        },
      ],
    },
    {
